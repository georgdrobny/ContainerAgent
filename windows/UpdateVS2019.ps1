...
function Get-Bootstapper
{
    ...
    [string] $bootstrapperUri = "https://aka.ms/vs/16/release/{0}" -f $skuList[$SKU]
...
function Get-InstallPath
{
    ...
    [string] $defaultPath = "C:\Program Files (x86)\Microsoft Visual Studio\2019\{0}" -f $SKU
...
Write-Output "Starting Unattended Update of Visual Studio 2019 ($SKU)"
...
Write-Output "Downloading Visual Studio 2019 ($SKU) Bootstrapper"
[string] $bootstrapper = Get-Bootstapper -SKU $SKU

Write-Output "Updating Visual Studio 2019 ($SKU)"
